...
function wotd_custom_post_type() {
	$labels = array(
		'name'                => _x( 'Word of the Day', 'Post Type General Name', 'text_domain' ),
		'singular_name'       => _x( 'Word of the Day', 'Post Type Singular Name', 'text_domain' ),
		'menu_name'           => __( 'Word of the Day', 'text_domain' ),
		'name_admin_bar'      => __( 'Word of the Day', 'text_domain' ),
	...
	$args = array(
		...
		'description'         => __( 'Word', 'text_domain' ),
		'labels'              => $labels,
